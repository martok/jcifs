 ...
 * WINS, broadcasts, DNS, and LMHOSTS. See
 * <a href="../../resolver.html">Setting Name Resolution Properties</a>
 * and the <code>jcifs.resolveOrder</code> property. Changing jCIFS name
 * resolution properties can greatly affect the behavior of the client and may
...
public class UniAddress {
    ...
    static class QueryThread implements Runnable {
        ...
        QueryThread(Sem sem, String host, int type,
            ...
            Thread.currentThread().setName("JCIFS-QueryThread: " + host);
            this.sem = sem;
            this.host = host;
            this.type = type;
            this.scope = scope;
    ...
    static NbtAddress lookupServerOrWorkgroup(String name, InetAddress svr)
        ...
        try {
            synchronized (sem) {
                threadPool.submit(q1x);
                threadPool.submit(q20);
     ...
     * @throws java.net.UnknownHostException if there is an error resolving the
     * name
     */
